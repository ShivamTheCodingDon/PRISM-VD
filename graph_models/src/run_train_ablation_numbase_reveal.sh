...
[ ! -e ~/mlaf_data_rev ] && ln -s "/media/user1/One Touch1/00 Data/PRISM-VD" ~/mlaf_data_rev

# Paths to the generated UCG jsonlines (no spaces now!)
TRAIN_DATA=~/mlaf_data_rev/data/processed/${DATASET}/train_uscp.jsonlines
VAL_DATA=~/mlaf_data_rev/data/processed/${DATASET}/valid_uscp.jsonlines
TEST_DATA=~/mlaf_data_rev/data/processed/${DATASET}/test_uscp.jsonlines
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_rwr_cr0" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_rwr_cr0" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method cta_rwr \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_rwr_cr0.25" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_rwr_cr0.25" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method cta_rwr \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_rwr_cr0.5" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_rwr_cr0.5" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method cta_rwr \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_rwr_cr0.75" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_rwr_cr0.75" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method cta_rwr \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_rwr_cr1" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_rwr_cr1" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method cta_rwr \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_vpc_cr0" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_vpc_cr0" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method vpc \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_vpc_cr0.25" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_vpc_cr0.25" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method vpc \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_vpc_cr0.5" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_vpc_cr0.5" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method vpc \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_vpc_cr0.75" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_vpc_cr0.75" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method vpc \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Reveal_Abl/results_${DATASET_LOWER}_ucg_rgat_vpc_cr1" \
#     --save_weights_dir "/home/user1/vulaidrive/prism-vd/weights/weights_${DATASET_LOWER}_ucg_rgat_vpc_cr1" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --slice_method vpc \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_rgat_vpc_smoth0.1" \
...
#     --fusion gated --pooling attention --edge_num 11 --num_layers 1 \
#     --ignore_empty_cfg --fexpn --loss_mode wbce_only --focal_gamma 0.0 \
#     --context_mode random --pos_weight 3.0 --focal_alpha 1.0 \
#     --context_ratio 0.5 --label_smoothing 0.0  --max_guards 5\
#     --plot_tsne --aux_loss_weight 0.75 --patience 5
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_rgat_cta_rwr_smoth0.1" \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_rgat_vpc_smoth0.2" \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_rgat_cta_rwr_smoth0.2" \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_rgat_vpc_maxg3" \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_rgat_cta_rwr_maxg3" \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_rgat_vpc_maxg7" \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_rgat_cta_rwr_maxg7" \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_gat_cta_max7" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_gnn_rev/results_${DATASET_LOWER}_ucg_gat_vpc_max7" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_loss_rev/results_${DATASET_LOWER}_ucg_rgat_vpc_smoth0.2_mcd" \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_loss_rev/results_${DATASET_LOWER}_ucg_rgat_vpc_smoth0.2_no_slice" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
...
#     --val_data "$VAL_DATA" \
#     --test_data "$TEST_DATA" \
#     --output_dir "Devign_Abl_loss_rev/results_${DATASET_LOWER}_ucg_rgat_vpc_smoth0.2_no_slice_mcd" \
#     --model_name microsoft/codebert-base \
#     --batch_size 4 --grad_accum 16 --epochs 15 \
#     --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.1 \
#     --dropout_prob 0.3 --gnn rgat --no_slice \
