...
# Accepts dataset name as argument (default: DiverseVul)
DATASET=${1:-DiverseVul}

rm -rf ~/mlaf_data_div

# Ensure symlinks exist (set up once)
[ ! -e ~/mlaf_data_div ] && ln -s "/media/user1/One Touch1/00 Data/PRISM-VD" ~/mlaf_data_div

# Paths to the generated UCG jsonlines
TRAIN_DATA=~/mlaf_data_div/${DATASET}/train_uscp.jsonlines
VAL_DATA=~/mlaf_data_div/${DATASET}/valid_uscp.jsonlines
TEST_DATA=~/mlaf_data_div/${DATASET}/test_uscp.jsonlines
...
# =============================================================================
# RGAT + RWR — Focal Loss (alpha=0.90, gamma=3.0)
...
run python train_graph_models.py \
    ...
    --save_weights_dir "/media/user1/One Touch1/00 Data/PRISM-VD/weights_${DATASET_LOWER}_ucg_rgat_rwr_focal" \
    ...
    --loss_mode focal_only --focal_alpha 0.90 --focal_gamma 3.0 \
...
run python train_graph_models.py \
    ...
    --save_weights_dir "/media/user1/One Touch1/00 Data/PRISM-VD/weights_${DATASET_LOWER}_ucg_rgat_rwr_wbce_pw3" \
    --model_name microsoft/codebert-base \
    --batch_size 4 --grad_accum 16 --epochs 15 \
    --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.05 \
    --dropout_prob 0.3 --gnn rgat --slice_method cta_rwr \
...
run python train_graph_models.py \
    ...
    --save_weights_dir "/media/user1/One Touch1/00 Data/PRISM-VD/weights_${DATASET_LOWER}_ucg_rgat_vpc_focal" \
    --model_name microsoft/codebert-base \
    --batch_size 4 --grad_accum 16 --epochs 15 \
    --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.05 \
...
run python train_graph_models.py \
    ...
    --save_weights_dir "/media/user1/One Touch1/00 Data/PRISM-VD/weights_${DATASET_LOWER}_ucg_rgat_vpc_wbce_pw3" \
    --model_name microsoft/codebert-base \
    --batch_size 4 --grad_accum 16 --epochs 15 \
    --lr 2e-5 --lr_scratch 1e-4 --weight_decay 0.05 \
    --dropout_prob 0.3 --gnn rgat --slice_method vpc \
